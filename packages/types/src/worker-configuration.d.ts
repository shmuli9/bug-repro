/* eslint-disable */
// Generated by Wrangler by running `wrangler types ../../packages/types/src/worker-configuration.d.ts --strict-vars false` (hash: 03ebdc51d73978f3b10da8f32dc52121)
// Runtime types generated with workerd@1.20251125.0 2025-04-04
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("../../../apps/web/workers/app");
  }
  // commenting out the above interface causes pnpm run typecheck to pass
  // with it in, typecheck fails
  interface Env {
